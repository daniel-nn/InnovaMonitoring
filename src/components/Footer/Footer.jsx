        ...
        <div className=" flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full flex flex-col items-center justify-center">
              ...
              >
                <img src={logo} alt="logo" className="max-w-[250]" />
              </Link>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                ...
                <TooltipComponent content="LinkedIn" position="Top">
                  <Link
                    target="_top"
                    to={"https://www.linkedin.com/in/danny-v-409404161/"}
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-yellow-600 hover:scale-130 sm:mr-4 lg:mr-3 xl:mr-4">
                    <svg
                      width="16"
                      height="16"  
                    ...
                    >
                      ...
                      <path d="M3.2 3.2c0 .882-.716 1.6-1.6 1.6S0 4.082 0 3.2 0.716 1.6 1.6 1.6 3.2 2.318 3.2 3.2zM0 16V5.6h3.2V16H0zm6.4 0V5.6h3.2v1.44h.048c.448-.847 1.542-1.74 3.172-1.74 3.392 0 4.016 2.232 4.016 5.136V16H12.8v-4.48c0-1.067-.02-2.44-1.48-2.44-1.483 0-1.712 1.163-1.712 2.367V16H6.4z" />
                    </svg>
                  </Link>
                </TooltipComponent>
              </div>
