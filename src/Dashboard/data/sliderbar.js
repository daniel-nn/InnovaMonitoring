...
const SidebarLinks = () => {
  ...
  return [
    {
      title: t(
        "dashboard.dashboard-sliderbar.dashboard-section.dashboard-tittle"
      ),
      links: [
        {
    ...
    {
      title: t(
        "dashboard.dashboard-sliderbar.integral-management-section.integral-tittle"
      ),
      links: [
        {
          name: t(
            "dashboard.dashboard-sliderbar.integral-management-section.reports"
          ),
    ...
    {
      title: t(
        "dashboard.dashboard-sliderbar.graphical-insights-section.graphical-tittle"
      ),
      links: [
        {
          name: t(
